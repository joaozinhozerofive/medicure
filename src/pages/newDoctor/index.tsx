...
export default function NewDoctor(){
    ...
    async function handleCreateDoctor(){
        ...
        try{
            ...
            formData.append('residenceCode', residenceCode), 
            ...
            if(error?.response?.data?.message){
                ...
                toast.error("Não foi possível criar médico")
            }
        }finally{
            setIsLoading(false)
        }
    ...
    return(
        <div className={styles.newDoctorContainer}>
            ...
            <div className={styles.content}>
                ...
                <h2>Novo Doutor <FaUserDoctor color='black' /> </h2>
